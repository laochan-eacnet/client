...
namespace iidx
{
	...
	WEAK pattern<void()> finalize_music_data{ "48 8D A8 88 FD FF FF", -12, launcher::game::iidx };
...
#ifdef DEBUG
	WEAK pattern_extract<bool(float*, int)> test_fps{ "8B 50 38 E8 ? ? ? ? 84 C0", 5, launcher::game::iidx };
#endif
