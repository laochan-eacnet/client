...
namespace laochan::embedded
{
    ...
    inline auto all()
    {
        ...
        rtn.emplace("assets/index-CRQPDoSy.css", saucer::embedded_file{"text/css", read_resource(ID_ASSET_4)});
        rtn.emplace("assets/index-D4xbksup.js", saucer::embedded_file{"text/javascript", read_resource(ID_ASSET_5)});
